 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ServerWS/", wsdlLocation = "http://localhost:8080/Recados/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ServerWS/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Recados/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://ServerWS/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ServerWS/", "NewWebServicePort"), NewWebService.class, features);
    }
